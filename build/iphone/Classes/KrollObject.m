 ...
 * Copyright (c) 2009-2011 by CartCallWeb, Inc. All Rights Reserved.
...
//@interface CartCallWebObject : NSObject
//@end

@interface CartCallWebObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CartCallWebObject class]])
		{
			for (NSString *key in [[(CartCallWebObject*)o modules] allKeys])
			{
