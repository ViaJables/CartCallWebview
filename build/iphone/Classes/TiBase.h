...
// in simulator we redefine to format for CartCallWeb Developer console
...
{\
	NSString * exceptionName = [@"org.cartcallweb." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.cartcallweb";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UICartCallWebNativeItemNone = -1, 
	UICartCallWebNativeItemSpinner = -2,
	UICartCallWebNativeItemProgressBar = -3,
	
	UICartCallWebNativeItemSlider = -4,
	UICartCallWebNativeItemSwitch = -5,
	UICartCallWebNativeItemMultiButton = -6,
	UICartCallWebNativeItemSegmented = -7,
	
	UICartCallWebNativeItemTextView = -8,
	UICartCallWebNativeItemTextField = -9,
	UICartCallWebNativeItemSearchBar = -10,
	
	UICartCallWebNativeItemPicker = -11,
	UICartCallWebNativeItemDatePicker = -12,
	
	UICartCallWebNativeItemInfoLight = -13,
	UICartCallWebNativeItemInfoDark = -14,
	
	UICartCallWebNativeItemDisclosure = -15,
	
	UICartCallWebNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all CartCallWeb instances of
