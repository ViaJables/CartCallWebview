...
/**
 Base class for all CartCallWeb views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the CartCallWeb view hierarchy (such as wrapped iOS UIViews) was touched.
