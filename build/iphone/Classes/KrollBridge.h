...
@interface CartCallWebObject : KrollCoverageObject {
#else
@interface CartCallWebObject : KrollObject {
#endif
@private
...
extern NSString * CartCallWeb$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	CartCallWebObject *_cartcallweb;
    KrollObject* console;
	BOOL shutdown;
