...
/**
 The base class for all CartCallWeb modules
 */
...
/**
 CartCallWeb Platform calls this method on startup.
 */
-(void)startup;

/**
 CartCallWeb Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 CartCallWeb Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 CartCallWeb Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 CartCallWeb Platform calls this method on resume.
 @param sender The sender of the event.
 */
